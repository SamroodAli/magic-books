...
A books management project for the fictional company Magic-books Inc.
## Built With
...
[heroku link](https://samrood-magic-books.herokuapp.com/)
...
```sh
  $ git clone https://github.com/SamroodAli/magic-books.git
